...
$GLOBALS['Page_API_Error_Code'] = 'P9';
...
<head>
    ...
    <script src="<?php echo PagesScripts; ?>PurchasesScript.js"></script>
...
<body>
        ...
        <div class = 'SectionDiv'>
            ...
            <div style="text-align: left;">
                ...
                <div style="margin-left: 77px;">
                    id = &nbsp;<input type="text" class="Input_ReadOnly" 
                        value="<?php
    include_once MySqlDB;
    include_once HashClass;
    if ( ($Result = $MySql->GetRowCount('SELECT COUNT(*) FROM bill WHERE status = "2"')) 
                                == -1 ){
        $Result = array(-1, $MySql->Error, 'Getting Purchase id', 'in Purchases');
    ?>">
    ...
    <?php
        ...
        echo $Result+1;
                        ?>"
                            readonly style="margin-right: 380px;width: 100px;">
...
?>
                    ...
                    Type Of Buying =<input type="radio" name="Buying" class="RadioButton">Deferred
                    <input type="radio" name="Buying" class="RadioButton" checked>Cash
                </div>
                ...
                <div>
                    ...
                    in Store = &nbsp;<input type="text" class="Input_ReadOnly"
                        readonly style="width: 80px;" value="0" id="Store">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    WholeSale Price = &nbsp;<input type="text" class="Input_ReadOnly"
                        readonly style="width: 80px;" value="0" id="WSP">
                    &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td style="padding: 5;margin:0 ;">
                                <input type="text" class="Input_Data"
                                    id="TypeDiscount1" style="width: 70px;margin: 0;"
                                    placeholder="0" name="TypeDiscount1"
                                    oninput="GetTypeDiscount(1);"> %
                ...
                <div style="text-align: center;">
                    <input type="button" class="Button" value="Save Purchase" 
                                    id="SavePurchase">
                </div>
            </div>
