                ...
                if ( Data['Result'] == 0 ){
                    ...
                    if ( typeof Data['Object'] == 'object' ){
                        ...
                        if ( Data['Object'][0] == 0 ){
                            $('#Store').css('border-color', 'red');
                            $('#WSP').css('border-color', 'red');
                            $('#TypeName'+The_ID).css('border-color', 'red');
                            $('#TypePrice'+The_ID).css('border-color', 'red');
                            $('#TypeTotall'+The_ID).css('border-color', 'red');
                            $('#TypeDiscount'+The_ID).css('border-color', 'red');
                            $('#TypeQuantity'+The_ID).css('border-color', 'red');
                            $('#Result').text('The Store is Empty');
                        }
                    }
                    else{
    ...
    $('<tr>'+
        ...
        '<td style="padding: 5;margin:0 ;">'+
            '<input type="text" class="Input_ReadOnly" readonly '+
                'id="TypeDiscount'+Count_Rows+'" style="width: 80px;margin: 0;"'+
    ...
    for ( i = 1; i <= Count_Rows; i++ ){
        if ( $('#TypeID'+i).val().length != 0 ){
            if ( $('#TypeName'+i).val().length != 0 ){
                ...
                Data += '&TypeDiscount'+i+'='+$('#TypeDiscountHidden'+i).val();
            ...
            try{
                ...
                if ( Data['Result'] == 0 ){
                    ...
                    if ( Data['Object'] != 'Done' )
                        ...
                        SetMessage(2500, 'green', '<p>The Bill is Saved</p>');
                        setTimeout(function () {
